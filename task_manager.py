        ...
        while self.running:
            try:
                ...
                for task in tasks:
                    ...
                    # 予告通知
                    if notification_times["pre"] is not None and self._should_trigger_notification(
                        current_time,
                    ...
                    # 本通知
                    if notification_times["main"] is not None and self._should_trigger_notification(
                        current_time,
                    ...
                    # 警告通知（未完了の場合のみ）
                    if notification_times["warning"] is not None and self._should_trigger_notification(
                        current_time,
